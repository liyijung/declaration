(() => {
  ...
  const IMPORT_HEAD_FIELDS = [
    ...
    'DOC_IMP_DATE','DCL_DATE','DOC_EXP_DATE','LOT_NO','PROC_NO','EXAM_TYPE','COPY_NUM',
    'DCL_PASS_METHOD','TERMS_SALES','FOB_AMT','DOC_IMP_CIF_AMT','DOC_IMP_CIF_TWD','P_DOC_ITEM_FRN',
    'CURRENCY','FRT_AMT','INS_AMT','ADD_AMT','SUBTRACT_AMT','MESSAGE_TYPE',
    'SHPR_CODE','SHPR_C_NAME','SHPR_E_NAME','SHPR_C_ADDR','SHPR_E_ADDR','SHPR_BAN_ID',
    'SHPR_BONDED_ID','DCL_DOC_DUTY_VIA','DCL_DOC_CASE_NO','DOC_RELATIONS','SHPR_AEO',
    'NX_PayAccountBisID','CNEE_CODE','CNEE_E_NAME','CNEE_E_ADDR','CNEE_C_NAME','CNEE_C_ADDR',
    'CNEE_BAN_ID','CNEE_BONDED_ID','CNEE_COUNTRY_CODE', 'CNEE_AEO','CO_PACKING_NOTE',
    'APP_PERMIT','STOCK_IN_CTN','FAC_BAN_ID_EX','FAC_BONDED_ID_EX','EX_TAX_AMT_1',
    'DOC_MARKS_DESC','DOC_OTR_DESC','REMARK1','DELIVER_TO','MEMO2','NX_UNIQUE_NO'
  ];

  const IMPORT_ITEM_FIELDS = [
    'ITEM_NO','DESCRIPTION','TERMS','QTY','DOC_UM','DOC_UNIT_P','FOB_TWD','PER','DOC_TOT_P',
    'BUYER_ITEM_CODE','SELLER_ITEM_CODE','GOODS_BRAND','GOODS_MODEL','GOODS_SPEC','CCC_CODE',
    'TAX_RATE_P','PERCENT_OF_AMT','SUB_CCC_CODE','CCC_ADD_1','COMM_TAX_RATE','TAX_METHOD','ST_QTY','ST_UM',
    ...
    'GOV_ASGN_NO9','GOV_ASGN_NO10','EXP_NO','EXP_NO2','EXP_NO3','EXP_NO4','EXP_NO5','EXP_SEQ_NO',
    'EXP_SEQ_NO2','EXP_SEQ_NO3','EXP_SEQ_NO4','EXP_SEQ_NO5','org_DCL_NO','org_DCL_NO_ITEM',
    'org_EXP_DCL_NO','org_EXP_DCL_ITEM','PO','PO_ITEM','P_QTY','P_UM','ISCALC_WT','NET_WT',
    'INN','IND','RER','LOT','CustSref','AtaRef','EXAM_CODE','DOMESTIC_RATE',
    'LUXURY_TAX_RATE','LUXURY_THRESHOLD','WIDE','WIDE_UM','LENGT_','LENGTH_UM',
    'BONDED_QTY','BONDED_UM','AFTER_TAX_AMT_ROR','ROR_MANU',
    'ORIGIN_CERTIFICATE_NO','ORIGIN_CERTIFICATE_ITEM','OTHER_TAX_ID_1','OTHER_TAX_ID_2',
    'OTHER_TAX_ID_3','OTHER_TAX_ID_4','OTHER_TAX_ID_5','OTHER_TAX_ID_6','OTHER_TAX_ID_7',
    'OTHER_TAX_ID_8','OTHER_TAX_ID_9','remark_01','remark_02','remark_03',
    'remark_04','remark_05','remark_06','remark_07','remark_08','remark_09','remark_10'
  ];
