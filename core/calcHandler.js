...
function calculateAmounts() {
    ...
    if (
        calculatedTotalAmount.toFixed(decimalPlaces) === totalDocumentAmount.toFixed(decimalPlaces) ||
        calculatedTotalAmount.toFixed(2) === totalDocumentAmount.toFixed(2) ||
        Math.abs(calculatedTotalAmount - totalDocumentAmount) < 0.0001
    ) {        
